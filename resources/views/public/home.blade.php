    ...
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
            <div class="flex flex-wrap gap-2 mb-5">
                <span class="inline-flex items-center gap-1.5 text-xs font-medium bg-indigo-50 text-indigo-700 px-3 py-1 rounded-full animate-fade-in-up anim-delay-100">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                    Priority Access
                </span>
                <span class="inline-flex items-center gap-1.5 text-xs font-medium bg-purple-50 text-purple-700 px-3 py-1 rounded-full animate-fade-in-up anim-delay-200">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    Ticket Assistance
                </span>
                <span class="inline-flex items-center gap-1.5 text-xs font-medium bg-green-50 text-green-700 px-3 py-1 rounded-full animate-fade-in-up anim-delay-300">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4 animate-fade-in-up anim-delay-200">
                Priority Ticket Assistance<br>
                <span class="text-indigo-600">for High-Demand Events</span>
            </h1>

            <p class="text-gray-500 text-base leading-relaxed mb-8 max-w-md animate-fade-in-up anim-delay-300">
            ...
            <div class="flex flex-wrap gap-3 animate-fade-in-up anim-delay-400">
        ...
        {{-- Right --}}
        <div class="flex justify-center md:justify-end animate-slide-in-right anim-delay-300">
            <div class="bg-white border border-gray-100 rounded-2xl p-5 w-full max-w-sm shadow-sm hover-glow transition-all duration-300">
                ...
                <div class="space-y-2">
                    @forelse($previewSuccess as $i => $log)
                        @php
                            ...
                            $qty = $log->qty;
                        @endphp
                        <div class="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2 animate-fade-in-up anim-delay-{{ ($i + 3) * 100 }}">
...
{{-- STATS --}}
<section class="border-y border-gray-100 bg-white scroll-animate">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
            ...
            <div class="py-8 px-6 text-center scroll-animate" data-delay="{{ $i * 100 }}">
                <div class="text-3xl font-bold text-indigo-600 mb-1 animate-count-up">{{ $stat['value'] }}</div>
...
<section class="py-14 px-4" id="active-events">
    <div class="max-w-7xl mx-auto">
        <div class="flex items-end justify-between mb-8 scroll-animate">
            <div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="scroll-animate" data-delay="{{ $i * 120 }}">
...
<section class="bg-gray-900 py-12 px-4" id="monitor">
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center gap-3 mb-6 scroll-animate">
        ...
        <div class="space-y-2">
            ...
            @php
                ...
                $qty      = $log->qty;
            @endphp
            <div class="flex items-center gap-3 bg-gray-800 rounded-xl px-4 py-2.5 text-sm overflow-x-auto scroll-animate hover:bg-gray-750 transition-colors duration-200" data-delay="{{ $i * 80 }}">
...
<section class="py-14 px-4 bg-white" id="cara-order">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm scroll-animate hover-glow" data-delay="100">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-3 scroll-animate" data-delay="{{ 200 + $i * 100 }}">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 border border-gray-100 rounded-2xl p-5 shadow-sm scroll-animate hover-glow" data-delay="200">
                ...
                <div class="space-y-3">
                    @foreach($orderSteps as $i => $step)
                    <div class="flex items-start gap-3 scroll-animate" data-delay="{{ 300 + $i * 100 }}">
...
<section class="py-14 px-4 bg-white" id="faq">
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 text-center mb-2 scroll-animate">FAQ</h2>
        <p class="text-gray-500 text-sm text-center mb-8 scroll-animate" data-delay="100">Pertanyaan yang sering ditanyakan</p>
        ...
        <div class="space-y-3" x-data="{ open: null }">
            ...
            <div class="border border-gray-100 rounded-xl overflow-hidden scroll-animate hover-glow" data-delay="{{ $i * 80 }}">
                <button
