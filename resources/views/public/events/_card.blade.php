<div class="bg-white border border-gray-100 rounded-2xl overflow-hidden hover-lift hover:shadow-md transition-shadow">
    {{-- Banner --}}
    <div class="relative h-40 bg-gradient-to-br from-indigo-900 to-purple-900 overflow-hidden group">
    ...
    <div class="p-4">
        ...
        <a href="{{ route('events.show', $event->slug) }}"
            class="btn-animate block w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium py-2 rounded-lg transition-colors">
            View Detail
        </a>
    </div>
</div>
