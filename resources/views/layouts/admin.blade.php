...
<div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    {{-- SIDEBAR --}}
    <aside class="fixed inset-y-0 left-0 z-40 w-56 bg-white border-r border-gray-100 flex flex-col flex-shrink-0 transition-transform duration-300 ease-in-out transform -translate-x-full md:translate-x-0 md:static"
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-14 bg-white border-b border-gray-100 flex items-center px-5 gap-4 flex-shrink-0">
            <button @click="sidebarOpen = true" class="text-gray-500 hover:text-gray-600 focus:outline-none md:hidden" title="Buka Menu">
