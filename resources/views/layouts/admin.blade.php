...
<div class="flex h-screen overflow-hidden">
        ...
        <nav class="flex-1 py-3 overflow-y-auto">
            <div class="px-3 mb-1">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                ...
                <a href="{{ route('admin.events.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.events.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.orders.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.orders.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="px-3 mt-3 mb-1">
                ...
                <a href="{{ route('admin.monitor.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.monitor.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.reports.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.reports.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.search.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.search.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="px-3 mt-3 mb-1">
                ...
                <a href="{{ route('admin.integrations.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.integrations.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.statistics.index') }}"
                    class="flex items-center gap-2.5 px-2 py-2 rounded-lg text-sm transition-all duration-200
                    {{ request()->routeIs('admin.statistics.*') ? 'bg-indigo-50 text-indigo-600 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:translate-x-0.5' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-14 bg-white border-b border-gray-100 flex items-center px-5 gap-4 flex-shrink-0">
            ...
            {{-- Search --}}
            <div class="flex items-center gap-2 bg-gray-50 border border-gray-100 rounded-lg px-3 py-1.5 w-52">
                <svg class="w-3.5 h-3.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                </svg>
                <span class="text-xs text-gray-400">Global search...</span>
            </div>

            {{-- Notif --}}
            <button class="w-8 h-8 rounded-lg border border-gray-100 flex items-center justify-center relative hover:bg-gray-50 transition-all duration-200 hover:scale-105 active:scale-95">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                </svg>
                <span class="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse-soft"></span>
            </button>
        </header>
