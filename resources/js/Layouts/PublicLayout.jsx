...
export default function PublicLayout({ children, title, description, hideNav = false, hideFooter = false, hideFloating = false }) {
            ...
            {!hideNav && (
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] font-medium text-gray-400 tracking-tight">Warindong</span>
                    </div>
