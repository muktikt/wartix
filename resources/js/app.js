...
function initScrollReveal() {
    ...
    // Fail-safe: if something goes wrong (slow script, blocked JS elsewhere,
    // very short/odd viewport, etc.) never leave content permanently invisible.
    setTimeout(() => {
...
// Run reveal init as early as possible instead of waiting only on
// DOMContentLoaded, and also as a safety net on window 'load'.
