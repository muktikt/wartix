...
class EventBuilderController extends Controller
{
    ...
    private function rules(): array
    {
        return [
            ...
            'platform_type'       => 'required|in:tiketcom,loket,yesplis,goers,fasticket,custom',
            'status'              => 'required|in:upcoming,slot_penuh,ongoing,finished',
            'banner_image'        => 'nullable|extensions:jpg,jpeg,png,webp|max:2048',
            'seatplan_image'      => 'nullable|extensions:jpg,jpeg,png,webp|max:2048',
